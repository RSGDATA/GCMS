...
rhythmsOfBelonging: {
  ...
  ticketUrl: "https://www.etix.com/ticket/p/31827899/rhythms-of-belonging-greenville-greenville-municipal-auditorium"
    ...
    windsOfChange: {
    title: "An Afternoon with Rachmaninoff and Mendelssohn",
    subtitle: "",
    description: "Join us for an intimate afternoon of chamber music featuring the romantic passion of Rachmaninoff and the lyrical elegance of Mendelssohn, alongside a charming work by Dvořák.",
    image: getImagePath("/AnAfternoon.png"),
    imageAlt: "Musicians performing with wind instruments and piano",
    aboutTitle: "Program",
    aboutDescription: [
      "Violin: Seowon Lee",
      "Cello: Tsun-yuet Emmanuel Kwok",
      "Piano: Xinzhuo Li",
      "",
      "─────────────────────────────────────────────────────────",
      "",
      "Antonín Dvořák (1841–1904): Romantische Stücke, Op. 75: No. 1",
      "",
