    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-900 to-slate-800">
      ...
      <section className="py-16 px-4 bg-black/20">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-white mb-8">About Ashley Concerts</h2>
          ...
          <div className="prose prose-lg text-gray-300 space-y-6">
            ...
            <h3 className="text-2xl font-bold text-white mt-8 mb-4">Performance Highlights</h3>
            ...
            <h3 className="text-2xl font-bold text-white mt-8 mb-4">This Season's Ashley Concerts</h3>
            <div className="grid md:grid-cols-2 gap-6 mt-6">
              <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6">
                <h4 className="text-xl font-semibold text-white mb-2">Fall Recital</h4>
                <p className="text-gray-300 text-sm mb-3">
                  An evening of classical favorites and contemporary works
                </p>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6">
                <h4 className="text-xl font-semibold text-white mb-2">Holiday Performance</h4>
                <p className="text-gray-300 text-sm mb-3">
                  Festive program featuring seasonal classics and beloved favorites
                </p>
                <div className="space-y-1 text-sm text-gray-300">
                  <div className="flex items-center">
                    <Calendar className="h-4 w-4 mr-2" />
